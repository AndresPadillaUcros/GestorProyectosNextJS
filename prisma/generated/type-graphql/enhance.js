...
const relationResolversInfo = {
    ...
    Proyecto: ["ObjetivosEspecificos", "lider", "avances", "inscripciones"],
...
const modelsInfo = {
    ...
    Proyecto: ["id", "nombre", "presupuesto", "fechaInicio", "fechaFin", "estado", "fase", "objetivoGeneral", "usuarioId"],
...
const outputsInfo = {
    ...
    ProyectoGroupBy: ["id", "nombre", "presupuesto", "fechaInicio", "fechaFin", "estado", "fase", "objetivoGeneral", "usuarioId", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    ProyectoCount: ["ObjetivosEspecificos", "avances", "inscripciones"],
    ProyectoCountAggregate: ["id", "nombre", "presupuesto", "fechaInicio", "fechaFin", "estado", "fase", "objetivoGeneral", "usuarioId", "_all"],
...
const inputsInfo = {
    ...
    ProyectoOrderByWithAggregationInput: ["id", "nombre", "presupuesto", "fechaInicio", "fechaFin", "estado", "fase", "objetivoGeneral", "usuarioId", "_count", "_avg", "_max", "_min", "_sum"],
    ProyectoScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "nombre", "presupuesto", "fechaInicio", "fechaFin", "estado", "fase", "objetivoGeneral", "usuarioId"],
    ...
    ProyectoCreateManyInput: ["id", "nombre", "presupuesto", "fechaInicio", "fechaFin", "estado", "fase", "objetivoGeneral", "usuarioId"],
    ...
    ProyectoCountOrderByAggregateInput: ["id", "nombre", "presupuesto", "fechaInicio", "fechaFin", "estado", "fase", "objetivoGeneral", "usuarioId"],
    ...
    ProyectoScalarWhereInput: ["AND", "OR", "NOT", "id", "nombre", "presupuesto", "fechaInicio", "fechaFin", "estado", "fase", "objetivoGeneral", "usuarioId"],
